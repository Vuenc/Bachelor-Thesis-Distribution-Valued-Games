...
\begin{document}
    ...
    \todo{Introduce Notations $[n]$, $\Rp$, alternating sequences and functions}
...
%        \end{subfigure}
    ...
    \lstinputlisting[language=R, firstline=67]{Code/leqtw-multiobjective/multiobjectiveSegmentGame.R}
    ...
    \lstinputlisting[language=R, firstline=42, lastline=55]{Code/leqtw-multiobjective/multiobjectiveSegmentGame.R}
